/*
 * softupd.h -- USB Raw Access Header
 *
...
#ifndef __LINUX_USB_SOFTUPD_H
#define __LINUX_USB_SOFTUPD_H
...
struct softupd_request_status {
	int			nr;
	int			status;
	unsigned int		nr_bytes;
};

struct softupd_queue_request {
	int			nr;
	unsigned int		nr_bytes;
};

#endif /* __LINUX_USB_SOFTUPD_H */
