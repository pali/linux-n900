...
/*
 * TODO: The following func is redefined in omap_device_hack.c, because
 * modules like dss, ssi, mmc are not based on omap_device fw.
 * The redefined function handles the request appropriatly.
 *
 * */
