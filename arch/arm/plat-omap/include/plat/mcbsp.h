...
/********************** McBSP Smart Idle modes *****************************/
#define MCBSP_SIDLE_FORCE_IDLE		0
#define MCBSP_SIDLE_NO_IDLE		1
#define MCBSP_SIDLE_SMART_IDLE		2

/********************** McBSP Clock Activity ******************************/
#define MCBSP_CLKACT_IOFF_FOFF		0
#define MCBSP_CLKACT_ION_FOFF		1
#define MCBSP_CLKACT_IOFF_FON		2
#define MCBSP_CLKACT_ION_FON		3
...
struct omap_mcbsp {
	...
	int pm_state_locked:1;
	omap_mcbsp_pm_state pm_state;
#endif
	void *reg_cache;
};
...
int omap_mcbsp_set_sidle_mode(unsigned int id, u16 sidle_mode,
			      u16 clk_activity);
...
static inline int omap_mcbsp_set_dma_op_mode(unsigned int id,
					     unsigned int mode) { return 0; }
int omap_mcbsp_set_sidle_mode(unsigned int id, u16 sidle_mode,
			      u16 clk_activity) { return 0; }

omap_mcbsp_pm_state omap_mcbsp_get_pm_state(unsigned int id) { return 0; }
int omap_mcbsp_set_pm_state(unsigned int id,
			    omap_mcbsp_pm_state pm_state) { return 0; }
#endif
