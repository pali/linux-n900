...
struct omap_dss_board_info {
	...
	void (*set_min_bus_tput)(struct device *dev, u8 agent_id,
			unsigned long r);
	void (*set_max_dev_wakeup_lat)(struct device *dev, long t);
	int num_devices;
...
struct omap_dss_device {
	...
	/* skip reset on first display enable sequence */
...
bool omapdss_dsi_vc_is_hs_enabled(int channel);
...
void omap_dsi_cancel_update_sync(struct omap_dss_device *dssdev);
