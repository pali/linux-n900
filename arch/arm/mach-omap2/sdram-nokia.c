/*
 * SDRC register values for Nokia OMAP devices
 *
...
static const struct sdram_timings nokia_166_timings[] = {
	{
		.casl = 3,
		.tDAL = 33000,
		.tDPL = 15000,
...
static const struct sdram_timings nokia_185_timings[] = {
	{
		.casl = 3,
		.tDAL = 5780,
		.tDPL = 15000,
...
static const struct sdram_timings nokia_97_6_timings[] = {
	{
		.casl = 3,
		.tDAL = 30725,
		.tDPL = 15362,
...
static const struct sdram_timings nokia_195_2_timings[] = {
	{
		.casl = 3,
		.tDAL = 30725,
		.tDPL = 15362,
...
static const struct sdram_timings nokia_200_timings[] = {
	{
		.casl = 3,
		.tDAL = 30000,
		.tDPL = 15000,
...
static struct omap_sdrc_params nokia_sdrc_params[8];
...
struct omap_sdrc_params *nokia_get_sdram_timings(void)
{
	...
	/* Fill up our table with all memory timings we have */
	err = sdrc_timings(0, 83000000, nokia_166_timings);
	err |= sdrc_timings(1, 92500000, nokia_185_timings);
	err |= sdrc_timings(2, 97600000, nokia_97_6_timings);
	err |= sdrc_timings(3, 100000000, nokia_200_timings);
	err |= sdrc_timings(4, 166000000, nokia_166_timings);
	err |= sdrc_timings(5, 185000000, nokia_185_timings);
	err |= sdrc_timings(6, 195200000, nokia_195_2_timings);
	err |= sdrc_timings(7, 200000000, nokia_200_timings);
