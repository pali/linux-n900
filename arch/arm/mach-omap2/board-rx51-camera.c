...
/* Code copied from http://patchwork.linuxtv.org/patch/10222/
   rm680_sec_camera_platform_data and adopted for rx51 */
static struct smiapp_platform_data rx51_smiapp_sensor_platform_data = {
	/* FIXME: in old smia-sensor driver ext_clk was: 9.6 * 1000 * 1000 */
