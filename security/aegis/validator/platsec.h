...
#ifndef AEGIS_VALIDATOR_PLATSEC_H
#define AEGIS_VALIDATOR_PLATSEC_H

#ifdef CONFIG_OMAP_SEC
int check_rd_certificate(void);
#else
static int check_rd_certificate(void)
{
	return -EINVAL;
}
#endif

#endif /* AEGIS_VALIDATOR_PLATSEC_H */
